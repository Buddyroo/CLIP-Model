...
def create_thumbnails_for_video_message(
    ...
    if not scenes:
        ...
        first_scene = (
        FrameTimecode(timecode='00:00:00', fps=video_fps), FrameTimecode(timecode='00:00:00', fps=video_fps))
    ...
    for i, (scene_start, _) in enumerate(scenes):
        ...
        try:
            ...
            print(f"Saved frame {i + 1}/{len(scenes)}")
        except Exception as e:
            print(f"Failed to save frame {i + 1}/{len(scenes)}: {str(e)}")
