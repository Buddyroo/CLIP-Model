...
def process_only_text_data(video_id):
    ...
    json_file_path = 'transcriptions_all.json'

    with open(json_file_path, 'r', encoding='utf-8') as file:
        all_videos = json.load(file)

    text = all_videos.get(video_id, {}).get('transcription', None)
...
with open('ADD_to_db/audio_vectors.json', 'w', encoding='utf-8') as file:
